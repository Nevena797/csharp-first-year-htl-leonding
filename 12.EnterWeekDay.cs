...
switch (ersterBuchstabe)
{
    case 'M':
        ...
        char zweiterBuchstabeM = char.ToUpper(Console.ReadKey().KeyChar);
        Console.WriteLine();
    ...
    case 'D':
        ...
        Console.WriteLine("Bitte geben Sie den zweiten Buchstaben ein:");
        char zweiterBuchstabeD = char.ToUpper(Console.ReadKey().KeyChar);
        Console.WriteLine();
    ...
    case 'S':
        ...
        Console.WriteLine("Bitte geben Sie den zweiten Buchstaben ein:");
        char zweiterBuchstabeS = char.ToUpper(Console.ReadKey().KeyChar);
        Console.WriteLine();
...
switch (firstLetter)
{
    case 'J':
        ...
        char secondLetterJ = char.ToUpper(Console.ReadKey().KeyChar);
        Console.WriteLine();
        if (secondLetterJ == 'A')
        {
        ...
        else if (secondLetterJ == 'U')
        {
            ...
            char thirdLetter = char.ToUpper(Console.ReadKey().KeyChar);
            Console.WriteLine();
            if (thirdLetter == 'N')
            {
    ...
    case 'M':
        ...
        char secondLetterM = char.ToUpper(Console.ReadKey().KeyChar);
        Console.WriteLine();
        if (secondLetterM == 'A')
        {
